...
projective great-circle base $\mathcal B$ to the A-generated normalized value groupoids. As in
Definition~\ref{def:residue-subdiagram}, $\int_{\mathcal B}\mathcal R_A$ is realized in the
Lean source as the total of the semantic C-residue input diagram over its input groupoid
